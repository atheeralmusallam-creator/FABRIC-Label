    ...
    <div className="flex-shrink-0 border-t border-[#2a2d3e] bg-[#13151e] px-5 py-4">
      <div className="mb-3">
        ...
        <textarea
          ...
          rows={2}
          className="w-full bg-[#0e0f14] border border-[#2a2d3e] focus:border-indigo-500/50 rounded-lg px-3 py-2 text-sm text-gray-300 outline-none transition-colors resize-none placeholder:text-gray-700"
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        <button
          onClick={onSkip}
          className="text-xs px-4 py-2 rounded-lg bg-[#1a1d27] border border-[#2a2d3e] text-gray-500 hover:text-yellow-400 hover:border-yellow-700/50 transition-colors"
        >
          Skip
        </button>
